...
#include "../runtime/asan.hpp" // mk::runtime::asan_poison_memory_region, mk::runtime::asan_unpoison_memory_region
	...
	mk::stdlib::ring_buffer_t<t, n>()
{
	...
	mk::runtime::asan_unpoison_memory_region(data(), other.size() * sizeof(t));
...
mk::stdlib::ring_buffer_t<t, n>::~ring_buffer_t() noexcept
{
	...
	mk::runtime::asan_poison_memory_region(data(), capacity() * sizeof(t));
}
...
void mk::stdlib::ring_buffer_t<t, n>::pop_back() noexcept
{
	...
	mk::runtime::asan_poison_memory_region(ptr, sizeof(t));
	--m_write;
}
...
void mk::stdlib::ring_buffer_t<t, n>::pop_back(mk::stdlib::size_t const& count) noexcept
{
	...
	mk::runtime::asan_poison_memory_region(sh.end() - sh_count, sh_count * sizeof(t));

	mk::stdlib::span_t<t> const fh = first_half();
	mk::stdlib::size_t const fh_count = count - sh_count;
	mk::stdlib::destroy_n(fh.end() - fh_count, fh_count);
	mk::runtime::asan_poison_memory_region(fh.end() - fh_count, fh_count * sizeof(t));
...
void mk::stdlib::ring_buffer_t<t, n>::pop_front(mk::stdlib::size_t const& count) noexcept
{
	...
	mk::runtime::asan_poison_memory_region(fh.begin() + fh_count, fh_count * sizeof(t));

	mk::stdlib::span_t<t> const sh = second_half();
	mk::stdlib::size_t const sh_count = count - fh_count;
	mk::stdlib::destroy_n(sh.begin() - sh_count, sh_count);
	mk::runtime::asan_poison_memory_region(sh.begin() - sh_count, sh_count * sizeof(t));
