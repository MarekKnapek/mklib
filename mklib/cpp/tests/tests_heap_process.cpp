...
void test_heap_process::test()
{
	test_heap_process::impl::test_default_construct();
	test_heap_process::impl::test_move_construct();
	test_heap_process::impl::test_move_assign();
	test_heap_process::impl::test_swap_member();
	test_heap_process::impl::test_swap_nonmember();
	test_heap_process::impl::test_alloc();
	test_heap_process::impl::test_size();
	test_heap_process::impl::test_realloc();
	test_heap_process::impl::test_realloc_inplace();
}


void test_heap_process::impl::test_default_construct()
{
...
void test_heap_process::impl::test_move_construct()
{
...
void test_heap_process::impl::test_move_assign()
{
	mk::stdlib::heap_process_t heap = mk::stdlib::heap_process_t::make();
...
void test_heap_process::impl::test_swap_member()
{
	mk::stdlib::heap_process_t heap = mk::stdlib::heap_process_t::make();
	mk::stdlib::heap_process_t heap_2;
...
void test_heap_process::impl::test_swap_nonmember()
{
	mk::stdlib::heap_process_t heap = mk::stdlib::heap_process_t::make();
	mk::stdlib::heap_process_t heap_2;
...
void test_heap_process::impl::test_alloc()
{
	mk::stdlib::heap_process_t heap = mk::stdlib::heap_process_t::make();
...
void test_heap_process::impl::test_size()
{
	mk::stdlib::heap_process_t heap = mk::stdlib::heap_process_t::make();
	mk::stdlib::uint64_t* const p_num = static_cast<mk::stdlib::uint64_t*>(heap.alloc(sizeof(mk::stdlib::uint64_t)));
...
void test_heap_process::impl::test_realloc()
{
	mk::stdlib::heap_process_t heap = mk::stdlib::heap_process_t::make();
	mk::stdlib::uint64_t* const p_num = static_cast<mk::stdlib::uint64_t*>(heap.alloc(sizeof(mk::stdlib::uint64_t)));
	*p_num = 0x1234567890abcdefull;
...
void test_heap_process::impl::test_realloc_inplace()
{
